...
bool test_tgamma_for_issue396_cpp_dec_float_020_through_050()
{
  const bool b_020 = test_tgamma_for_issue396<20U>();
  const bool b_030 = test_tgamma_for_issue396<30U>();
  const bool b_040 = test_tgamma_for_issue396<40U>();
  const bool b_049 = test_tgamma_for_issue396<49U>();
  const bool b_050 = test_tgamma_for_issue396<50U>();

  const bool result_is_ok = (b_020 && b_030 && b_040 && b_049 && b_050);
